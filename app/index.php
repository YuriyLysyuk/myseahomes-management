...
<head>
  ...
  <meta name="description" content="<?= $ml->tr('Превратите свою квартиру в номер прибыльного апарт-отеля') ?>" />
...
<body>
  ...
  <section class="hero">
    <div class="wrap">
      <h1>
        <span class="hero__subtitle"><?= $ml->tr('Отдел менеджмента') ?></span><br />
        <span class="text--accented">My</span>seahomes
      </h1>
      <p class="hero__desc">
        <span class="text--accented">/</span> <?= $ml->tr('Превратите свою квартиру на Кипре в номер') ?> <br>
        <span class="text--accented text--uppercased text--underlined text--bolded"><?= $ml->tr('прибыльного апарт-отеля') ?></span>
      </p>
      ...
      <div class="differents__grid">
        <div class="differents__item">
          ...
          <div class="differents__item__desc">
            <?= $ml->tr('Обеспечиваем постоянную заполняемость за счет профессиональной рекламы.') ?>
          </div>
        </div>
        <div class="differents__item">
          <div class="differents__item__number">
          ...
          <div class="differents__item__desc">
            <?= $ml->tr('Защищаем ваши интересы за счет регулярного контроля оплат, проверки состояния квартиры и юридического сопровождения.') ?>
          </div>
        </div>
        <div class="differents__item">
          <div class="differents__item__number">
          ...
          <div class="differents__item__desc">
            <?= $ml->tr('Увеличиваем доходность с помощью консьерж-сервиса и широкого спектра допуслуг.') ?>
          </div>
        </div>
        <div class="differents__item">
          <div class="differents__item__number">
          ...
          <div class="differents__item__desc">
            <?= $ml->tr('Мы работаем в сфере доверительного управления с 2015 года и знаем как быстро сдать апартаменты, виллу или бунгало на прозрачных и выгодных условиях для собственника.') ?>
          </div>
        </div>
        <div class="differents__item">
          <div class="differents__item__number">
          ...
          <div class="differents__item__desc">
            <?= $ml->tr('Ваша квартира сохранится в отличном состоянии. Вы будете получать своевременную и полную отчетность по заселениям. Вы всегда сможете приехать в отпуск в готовую для проживания квартиру.') ?>
          </div>
        </div>
  ...
  <section class="more">
    <div class="wrap">
      ...
      <div class="text--smaller">
        <?= $ml->tr('Заполните форму ниже и мы сделаем бесплатный аудит и приблизительный прогноз по результатам') ?>
      </div>
    ...
    <div class="wrap">
      <div class="services__item">
        ...
        <div class="services__box">
          <h3><span class="text--accented"><?= $ml->tr('Доверительное') ?></span> <?= $ml->tr('управление вашей недвижимостью') ?></h3>
          <p>
            <?= $ml->tr('Полный спектр услуг по управлению недвижимостью, чтобы помочь своим клиентам во всех аспектах их инвестиций в недвижимость.') ?>
          </p>
      ...
      <div class="services__item">
        ...
        <div class="services__box">
          <h3><span class="text--accented"><?= $ml->tr('Консьерж-сервис') ?></span></h3>
          <p>
            <?= $ml->tr('Предлагаем вашему вниманию услуги консьержа на Северном Кипре. Наши представители станут вашими настоящими помощниками в любых ваших вопросов.') ?>
          </p>
          <button class="btn trigger"><?= $ml->tr('Узнать подробнее') ?></button>
        </div>
      </div>
    ...
    <div class="wrap">
      ...
      <div class="offer__grid">
        ...
        <div class="offer__item line__bottom">
          ...
          <h3>
            <span class="text--accented"><?= $ml->tr('Аудит') ?></span> <?= $ml->tr('недвижимости') ?>
          </h3>
          <p><?= $ml->tr('Мы проводим аудит вашей недвижимости: оценка состояния, расчет доходности, рекомендации по повышению стоимости сдаваемого жилья.') ?></p>
        ...
        <div class="offer__item line__bottom line__bottom--last">
          ...
          <p><?= $ml->tr('Вы выбираете дополнительные услуги (профессиональная фото/видеосъемка, декорирование, покупка бытовых принадлежностей, полная комплектация объекта под сдачу и др.)') ?></p>
          <div class="offer__number"><span>3</span></div>
        </div>
        <div class="offer__item line__bottom">
          <i class="fas fa-rocket"></i>
          <h3><span class="text--accented"><?= $ml->tr('Запуск') ?></span> <?= $ml->tr('рекламы') ?></h3>
          <p><?= $ml->tr('Мы запускаем рекламу и обеспечиваем комплексное маркетинговое сопровождение вашего объекта.') ?></p>
          <div class="offer__number"><span>6</span></div>
        </div>
        <div class="offer__item line__bottom">
          <i class="fas fa-hammer"></i>
          <h3><span class="text--accented"><?= $ml->tr('Начало') ?></span> <?= $ml->tr('работы') ?></h3>
          <p><?= $ml->tr('Мы приступаем к выполнению необходимых работ по договору.') ?></p>
          <div class="offer__number"><span>5</span></div>
        </div>
        <div class="offer__item line__bottom line__bottom--last line__right">
          <i class="fas fa-file-contract"></i>
          <h3>
            <span class="text--accented"><?= $ml->tr('Подписание') ?></span> <?= $ml->tr('договора') ?>
          </h3>
          <p><?= $ml->tr('Мы подписываем договор доверительного управления, в котором юридически фиксируем нашу ответственность и обязательства перед собственником жилья.') ?></p>
        ...
        <div class="offer__item line__bottom line__left">
          ...
          <p><?= $ml->tr('Мы отвечаем за прием и обработку заявок, сопровождение арендаторов с момента бронирования до выезда.') ?></p>
        ...
        <div class="offer__item line__bottom">
          ...
          <p><?= $ml->tr('Вы получаете доход от сдачи жилья в аренду в соответствии с согласованными сроками по договору.') ?></p>
    ...
    <div class="wrap">
      ...
      <div class="why-we__grid">
        <div class="why-we__item why-we__item--bordered">
          <p>
            <span class="text--accented"><?= $ml->tr('Тщательный анализ') ?></span> <?= $ml->tr('и выбор надежных арендаторов') ?>
          </p>
        </div>
        <div class="why-we__item why-we__item--bordered">
          <p>
            <span class="text--accented"><?= $ml->tr('Контроль своевременного') ?></span> <?= $ml->tr('погашения арендной платы и коммунальных платежей') ?>
          </p>
        </div>
        <div class="why-we__item why-we__item--bordered">
          <p>
            <span class="text--accented"><?= $ml->tr('Решение всех') ?></span> <?= $ml->tr('необходимых вопросов с ремонтом, уборкой и обслуживанием, включая консьерж-сервис для арендаторов') ?>
          </p>
        </div>
        <div class="why-we__item why-we__item--bordered">
          <p>
        ...
        <div class="why-we__item why-we__item--bordered">
          <p>
            <span class="text--accented"><?= $ml->tr('Быстрое разрешение') ?></span> <?= $ml->tr('конфликтных ситуаций и бытовых вопросов с арендаторами') ?>
          </p>
        </div>
        <div class="why-we__item why-we__item--bordered">
          <p>
            <span class="text--accented"><?= $ml->tr('Обеспечение полной') ?> </span> <?= $ml->tr('сохранности вашей собственности, включая страхование и юридическую защиту интересов') ?>
          </p>
        </div>
  ...
  <div id="thank-you" data-izimodal-title="<?= $ml->tr('Спасибо!') ?>" data-izimodal-subtitle="<?= $ml->tr('Ожидайте звонка в течении 15 минут') ?>"></div>
